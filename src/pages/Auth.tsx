    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-3 border-[12px] border-red-600 rounded-3xl">
      ...
      <div className="w-full max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          ...
          <div className={`lg:col-span-2 text-center lg:text-left ${!isLogin && 'order-2 lg:order-1'}`}>
            <div className="mb-12">
              <h1 className="text-6xl lg:text-7xl font-bold mb-6 text-[#1a2332]">Hallo!</h1>
              <p className="text-3xl lg:text-4xl font-semibold text-[#1a2332]">
                Welcome To Form
              </p>
              <p className="text-3xl lg:text-4xl font-semibold text-[#1a2332] mt-2">
          ...
          <div className={`lg:col-span-3 flex items-center justify-center ${!isLogin && 'order-1 lg:order-2'}`}>
            <div className="bg-white rounded-2xl shadow-2xl p-8 lg:p-10 w-full border-[6px] border-red-600">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Fullname Input - Only for Register */}
                {!isLogin && (
